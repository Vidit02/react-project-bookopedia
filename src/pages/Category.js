...
export const Category = (props) => {
    ...
    return (
        <div>
            <AllCss />
            <NavigationBar />
            <section className="mt-0 " style={{textAlign:"left"}}>
                        ...
                        <div className="col-12 col-sm-6 col-lg-4">
                            ...
                            <div className="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                ...
                                <div className="card-body px-0">
                                    ...
                                    <small className="text-muted d-block">2 colours, 4 sizes</small>
                        ...
                        <div className="col-12 col-sm-6 col-lg-4">
                            ...
                            <div className="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                <div className="card-img position-relative">
                                    <div className="card-badges">
                                        <span className="badge badge-card">
                                            <span className="f-w-2 f-h-2 bg-secondary rounded-circle d-block me-1" />{" "}
                                            Sold Out
                                        </span>
                                    </div>
                                    <span className="position-absolute top-0 end-0 p-2 z-index-20 text-muted">
